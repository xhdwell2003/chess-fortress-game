...
class GameManager:
    ...
    def draw_game_over(self, screen):
        """绘制游戏结束界面"""
        title = self.font.render(f"游戏结束! 玩家{self.winner}获胜!", True, (0, 0, 0))
        screen.blit(title, (self.screen_width // 2 - title.get_width() // 2, self.screen_height // 2 - 50))
        
        # 绘制返回主菜单按钮
        pygame.draw.rect(screen, (100, 100, 255), (300, 350, 200, 50))
        menu_text = self.font.render("返回主菜单", True, (255, 255, 255))
        screen.blit(menu_text, (400 - menu_text.get_width() // 2, 375 - menu_text.get_height() // 2))
